我们在https://github.com/leafqycc/rknn-multi-threaded的基础上，对rknn_model_zoo中的yolov8-seg example进行了整合，用github copilot重写了后处理函数，取消了pytorch依赖同时将后处理耗时从几百毫秒降低到了几十毫秒。
# 简介
